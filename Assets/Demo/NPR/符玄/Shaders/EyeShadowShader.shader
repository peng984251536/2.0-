...
Shader "EyeShadowShader"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_ramp_coorColor("ramp_coorColor", 2D) = "white" {}
		_shadowColor("_shadowColor", Color) = (1,1,1,1)
		_RampUV("_RampUV", Vector) = (0.5,0.06,0,0)
		[ASEEnd]_AlpahVal("_AlpahVal", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( tex2D( _ramp_coorColor, _RampUV ) * _shadowColor ).rgb;
				float Alpha = _AlpahVal;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = _AlpahVal;
...
ASEEND*/
//CHKSM=7F54B8DB66133D67845E3CBA413A9E9F0DFA5114