...
public class GenshipSkyParams : MonoBehaviour
{
    ...
    public List<MeshRenderer> _skyRenderers = new List<MeshRenderer>();
    public List<MeshRenderer> _cloudRenderers = new List<MeshRenderer>();
