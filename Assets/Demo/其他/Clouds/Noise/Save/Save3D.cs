...
public class Save3D : MonoBehaviour {
    ...
    public void Save (RenderTexture volumeTexture, string saveName) {
        ...
        UnityEditor.AssetDatabase.CreateAsset (x, "Assets/Demo/其他/Clouds/tex/" + saveName + ".asset");
        UnityEditor.AssetDatabase.CreateAsset (slices[0], "Assets/Demo/其他/Clouds/tex/" + saveName+"_2D" + ".asset");
#endif
    }
