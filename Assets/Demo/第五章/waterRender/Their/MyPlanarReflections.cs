...
[ExecuteAlways]
public class MyPlanarReflections : MonoBehaviour
{
    [Serializable]
    ...
    private static void SafeDestroy(UnityObject obj)
    {
    ...
    private void UpdateReflectionCamera(Camera realCamera)
    {
        ...
        //设置近裁剪平面
        var clipPlane =
            CameraSpacePlane(_reflectionCamera, pos - Vector3.up * (0.2f - m_planeNearOffset), normal, 1.0f);
    ...
    private Camera CreateMirrorObjects()
    {
        ...
        cameraData.SetRenderer(1); //设置这个URP相机的渲染层级
    ...
    private int2 ReflectionResolution(Camera cam, float scale)
    {
        ...
        //Debug.LogFormat("Reflection int2 :{0},{1}", x, y);
        return new int2(x, y);
    }
