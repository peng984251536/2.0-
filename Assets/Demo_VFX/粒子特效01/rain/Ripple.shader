...
Shader "Ripple"
{
	Properties
	{
		...
		[ASEBegin]_New_Graph_output("New_Graph_output", 2D) = "white" {}
		_AlpahClip("_AlpahClip", Float) = 0.5
		[ASEEnd]_BaseColor("_BaseColor", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_New_Graph_output = IN.ase_texcoord3.xy * _New_Graph_output_ST.xy + _New_Graph_output_ST.zw;
				float4 tex2DNode10 = tex2D( _New_Graph_output, uv_New_Graph_output );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = _BaseColor.rgb;
				float Alpha = tex2DNode10.r;
				float AlphaClipThreshold = _AlpahClip;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_New_Graph_output = IN.ase_texcoord2.xy * _New_Graph_output_ST.xy + _New_Graph_output_ST.zw;
				float4 tex2DNode10 = tex2D( _New_Graph_output, uv_New_Graph_output );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_New_Graph_output = IN.ase_texcoord.xy * _New_Graph_output_ST.xy + _New_Graph_output_ST.zw;
				float4 tex2DNode10 = tex2D( _New_Graph_output, uv_New_Graph_output );
				
				surfaceDescription.Alpha = tex2DNode10.r;
				surfaceDescription.AlphaClipThreshold = _AlpahClip;
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_New_Graph_output = IN.ase_texcoord1.xy * _New_Graph_output_ST.xy + _New_Graph_output_ST.zw;
				float4 tex2DNode10 = tex2D( _New_Graph_output, uv_New_Graph_output );
...
/*ASEBEGIN
Version=18935
6.4;11.2;1523.2;783.8;1331.301;301.0393;1;True;True
Node;AmplifyShaderEditor.SamplerNode;10;-1606.148,56.05299;Inherit;True;Property;_New_Graph_output;New_Graph_output;0;0;Create;True;0;0;0;False;0;False;-1;9739d5ff1771a2e4e9ef9d2d3b05f93c;9739d5ff1771a2e4e9ef9d2d3b05f93c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-476.3013,154.5607;Inherit;False;Property;_AlpahClip;_AlpahClip;1;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;13;-950.2781,-85.1135;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ColorNode;16;-769.301,-113.8393;Inherit;False;Property;_BaseColor;_BaseColor;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;-269.2794,58.05812;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;Ripple;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;0;638359734456721650;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=A47F8CDAC0B9227ED23F97966A98F21A49C2788B